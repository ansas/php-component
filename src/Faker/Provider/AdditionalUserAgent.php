...
/**
 * Class AdditionalUserAgent
 *
 * @package Ansas\Faker\Provider
 * @author  Ansas Meyer <mail@ansas-meyer.de>
 */
class AdditionalUserAgent extends Base
{
    protected static $additionalUserAgents = [
     ...
     */
    public static function additionalUserAgent()
    {
        return static::randomElement(static::$additionalUserAgents);
    }
}
