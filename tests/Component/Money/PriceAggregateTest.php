...
class PriceAggregateTest extends TestCase
{
    ...
    public function testSinglePayment()
    {
        ...
        $this->assertEquals('{"gross":119,"net":100,"perTaxRate":{"19":{"gross":119,"net":100,"percent":19}}}', $priceAggregate->toJson());
    ...
    public function testMultiPayments()
    {
        ...
        $this->assertEquals('{"gross":226,"net":200,"perTaxRate":{"7":{"gross":107,"net":100,"percent":7},"19":{"gross":119,"net":100,"percent":19}}}', $priceAggregate->toJson());
